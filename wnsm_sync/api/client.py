...
class Smartmeter:
    ...
    def restore_session(self, session_data: dict):
        ...
        self._access_token_expiration = datetime.fromisoformat(session_data["access_token_expiration"]) if session_data["access_token_expiration"] else None
        self._refresh_token_expiration = datetime.fromisoformat(session_data["refresh_token_expiration"]) if session_data["refresh_token_expiration"] else None
